...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
       $name=$_POST['name'];
    $id=$_POST['product_id'];
    $count=$_POST['numberProduct'];
	$buyer=$_POST['buyer'];
	$address=$_POST['address'];
    $query=mysql_query("INSERT INTO cart(id_product,buyer, name_product, count_product,address) VALUES ('{$id}','{$buyer}','{$name}','{$count}','{$address}')")or die(mysql_error());
    if($query=='true')
