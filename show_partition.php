...
<form action="calculation_opinion.php" method="post" name="opinion" target="_self">
...
$myrow3 = mysql_fetch_array($itog3);
	...
	<p class='partition_comm'>добавить комментарий</p>	
		...
		<form action="processing_comments.php" method="post" name="comm_form">
		<p><label>ваше имя<br>
		...
		&nbsp;<p><input type="button" value="На предыдущую" class="button" onclick="javascript:window.location='show_heading.php'" /></p></td>
  </tr>
