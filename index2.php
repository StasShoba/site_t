...
<table width="1700" height="989" border="0,0001">
  ...
  <tr>
    ...
    <td height="220" colspan="5" background="img/top.jpg" >	<?php include("section/regform.php")?>	</td>
  </tr>
  <tr>
    <td height="160" colspan="6"  background="img/middle.jpg" align="center"><div align="center">sort by: <?php
include "connect.php";
$countries = array(
  'Africa'=>'Africa',
  'Brazil'=>'Brazil',
