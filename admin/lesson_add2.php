...
<table width="1490" height="989" border="1">
  ...
  <tr>
	...
	if(isset($pack)&&isset($country)&&isset($producer)&&isset($goods))
	{
	if ($product =='games'){
		$itog = "INSERT INTO games(pack,country,producer,goods) VALUES('$pack','$country','$producer','$goods')";
		$result=mysql_query($itog);
		} 
	if ($product =='fruits'){
		$itog2 = "INSERT INTO fruits(pack,country,producer,goods) VALUES('$pack','$country','$producer','$goods')";
		$result2=mysql_query($itog2);
	}
	
	if($result=='true'){
		echo"<p>Ваш товар успешно занесен в базу!</p>";
	}
	if($result2=='true'){
		echo"<p>Ваш товар успешно занесен в базу!</p>";
	}
		...
		echo"<p>Ваш товар не занесен в базу!</p>";
	}
