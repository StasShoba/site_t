...
<table width="1490" height="989" border="1">
  ...
  <tr>
    <td height="172" colspan="5"><h3 align="center"> удаления заметки</h3>
	<form action="article_remove_text.php" method="post">
	<?php 
	...
	do
	{
	printf("<p><input name='id'type='radio' value='%s'><label>%s</label></p>",$mas["id"],$mas["title"]);
    }
