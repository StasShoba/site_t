...
<table width="1490" height="989" border="1">
  ...
  <tr>
    <td height="172" colspan="5">
		 ...
		 if(isset($id))
{
/*Удаляем инофрмацию из базы*/
$itog=mysql_query("DELETE FROM games WHERE id='$id'");
$itog2=mysql_query("DELETE FROM fruits WHERE id='$id'"); 
if($itog=='true'){
echo"<p>Ваш товар успешно удален из базы!</p>";}
elseif($itog2=='true'){
echo"<p>Ваш товар успешно удален из базы!</p>";}
else{echo"<p>Ваш урок не удален из базы!</p>";}
}
else
{
echo"<p>Вы не выбрали какой урок нужно удалить, поэтому урок в базе не может быть удален из базы</p>";
}
