...
if(isset($_POST['game'])){$gameVal=$_POST['game'];}
if(isset($_POST['id'])){$idVal=$_POST['id'];}
$base=mysql_connect("localhost","admin","56789");
mysql_select_db("php_123",$base);
...
<table width="1490" height="989" border="1">
  ...
  <tr>
	...
	<form name="form1" method="post" action="lesson_del2.php">
    <p>
    <label></label>
