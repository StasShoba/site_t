...
if(isset($name))
{
if(empty($name) or strlen($mail) < 4 )
{
...
<table width="1490" height="989" border="1">
  ...
  <tr>
    <td height="70" colspan="5"  background="img/middle.jpg"><?php
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $query=mysql_query("INSERT INTO collectmail (name,mail) VALUES ('{$name}','{$mail}')")or die(mysql_error());
    if($query=='true')
    {echo"Ваши данные успшено добавлены";}
    else{echo"Ваши данные не добавлены";}
}


?>
&nbsp;<p style=" margin-left: 5px;"><input type="button" value="На Главную" class="button" onclick="javascript:window.location='index.php'" />
</td>
  </tr>
